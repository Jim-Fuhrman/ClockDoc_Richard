...
class Search {
  ...
  constructor() {
    this.addSearchHTML();
    /* addSearchHTML must be coded first; otherwise, the next lines will not run correctly. The elements they're trying to access won't even exist yet. */
  ...
  typingLogic() {
    ...
    /* we keep track of the search criteria's previous value so arrow keys won't trigger the spinner. */
  }
