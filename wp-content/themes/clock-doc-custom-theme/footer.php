            ...
            <div class="site-footer__inner container container--narrow">
                <div class="group">
                    <div class="site-footer__col-one">
                        ...
                        <h2><a href="<?php echo site_url(); ?>">Clock Doctor</a></h2>
                        <p>402-798-7470</p>
                    </div>
                    <div class="site-footer__col-two-three-group">
                        <div class="site-footer__col-two">
                            <h3 class="headline headline--medium">Shop around</h3>
                            <nav class="nav-list">
                                <ul>
                        ...
                        <div class="site-footer__col-three">
                            <h3 class="headline headline--medium">Learn</h3>
                            <nav class="nav-list">
                                <ul>
                    ...
                    <div class="site-footer__col-four">
                        <h3 class="headline headline--medium t-center">Connect With Us</h3>
                        <nav>
                ...
                <div class="site-footer__copyright-info">
                    <p class="t-small">&copy; Copyright 2021 | Clock Doctor | All Rights Reserved | Website created by Jim Fuhrman | Contact <a href="mailto: Jim Fuhrman@Yahoo.com">Jim Fuhrman</a></p>
                </div>
            </div>
        </footer>
